...
- (id)xpcCnx;
- (void)xpcTDSProviderActivate:(id)arg1 completion:(id)arg2;
- (void)xpcTDSSeekerActivate:(id)arg1 completion:(id)arg2;
- (void)xpcTDSSessionActivate:(id)arg1 completion:(id)arg2;
