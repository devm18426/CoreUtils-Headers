...
@property (nonatomic, copy) id identityCreatedHandler;
@property (nonatomic, copy) id identityDeletedHandler;
@property (nonatomic, copy) id interruptionHandler;
@property (nonatomic, copy) id invalidationHandler;
@property (nonatomic, copy) id pairedPeerAddedHandler;
@property (nonatomic, copy) id pairedPeerChangedHandler;
@property (nonatomic, copy) id pairedPeerRemovedHandler;
...
- (void)_getPairingIdentityWithOptions:(unsigned long long)arg1 tryCount:(unsigned int)arg2 completion:(id)arg3;
- (void)_interrupted;
- (void)_invalidate;
- (void)_invalidated;
