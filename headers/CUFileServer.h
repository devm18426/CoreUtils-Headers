...
- (void)_handleKeepAlive:(id)arg1 responseHandler:(id)arg2;
- (void)_handleQuery:(id)arg1 responseHandler:(id)arg2;
- (void)_handleQuery:(id)arg1 session:(id)arg2;
- (void)_handleRequestFiles:(id)arg1 responseHandler:(id)arg2;
- (void)_handleSessionStart:(id)arg1 responseHandler:(id)arg2;
- (void)_handleSessionStop:(id)arg1 responseHandler:(id)arg2;
- (void)_invalidate;
- (void)_invalidated;
