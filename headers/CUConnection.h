...
- (id)label;
- (id)peerEndpoint;
- (void)registerEventID:(id)arg1 options:(id)arg2 handler:(id)arg3;
- (void)registerRequestID:(id)arg1 options:(id)arg2 handler:(id)arg3;
- (void)sendEventID:(id)arg1 event:(id)arg2 options:(id)arg3 completion:(id)arg4;
- (void)sendRequestID:(id)arg1 request:(id)arg2 options:(id)arg3 responseHandler:(id)arg4;
